        ...
        <div class="row justify-content-center">
            <div class="col-12">
                <div class="row align-items-center mb-2">
                    <div class="col">
                        <h2 class="h5 page-title">{{ __('shard.welcome') }} <span
                        ...
                        <div class="card shadow">
                            <div class="card-body">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col pr-0">
                                        <p class="small text-muted mb-0">{{__('shard.services')}}</p>
                                        @php
                                            $services = App\Models\Service::all();
                                        @endphp
                                        <span class="h3 mb-0">{{ count($services) }}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card shadow">
                            <div class="card-body">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col pr-0">
                                          <p class="small text-muted mb-0">{{__('shard.blogs')}}</p>
                                          @php
                                              $blogs = App\Models\Blog::all();
                                          @endphp
                                          <span class="h3 mb-0">{{ count($blogs) }}</span>
                                      </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card shadow">
                            <div class="card-body">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col pr-0">
                                          <p class="small text-muted mb-0">{{__('shard.projects')}}</p>
                                          @php
                                              $projects = App\Models\Project::all();
                                          @endphp
                                          <span class="h3 mb-0">{{ count($projects) }}</span>
                                      </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card shadow">
                            <div class="card-body">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col pr-0">
                                          <p class="small text-muted mb-0">{{__('shard.Advisors')}}</p>
                                          @php
                                              $advisor = App\Models\Advisor::all();
                                          @endphp
                                          <span class="h3 mb-0">{{ count($advisor) }}</span>
                                      </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card shadow">
                            <div class="card-body">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col pr-0">
                                        <p class="small text-muted mb-0">{{__('shard.partner')}}</p>
                                        @php
                                            $partners = App\Models\Partner::all();
                                        @endphp
                                        <span class="h3 mb-0">{{ count($partners) }}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card shadow">
                            <div class="card-body">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col pr-0">
                                          <p class="small text-muted mb-0">{{__('shard.certificates')}}</p>
                                          @php
                                              $certificates = App\Models\Certificate::all();
                                          @endphp
                                          <span class="h3 mb-0">{{ count($certificates) }}</span>
                                      </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card shadow">
                            <div class="card-body">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col pr-0">
                                          <p class="small text-muted mb-0">{{__('shard.features')}}</p>
                                          @php
                                              $features = App\Models\Feature::all();
                                          @endphp
                                          <span class="h3 mb-0">{{ count($features) }}</span>
                                      </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card shadow">
                            <div class="card-body">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col pr-0">
                                          <p class="small text-muted mb-0">{{__('shard.feedback')}}</p>
                                          @php
                                              $feedback = App\Models\feedback::all();
                                          @endphp
                                          <span class="h3 mb-0">{{ count($feedback) }}</span>
                                      </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body" data-simplebar
                                ...
                                <div class="pb-3 timeline-item item-warning">
                                    <div class="pl-5">
                                        ...
                                        <div class="row mb-3">
                                            <div class="col"><img src="{{ asset('assets-admin') }}/products/p1.jpg"
                                                    alt="..." class="img-fluid rounded"></div>
                                            <div class="col"><img src="{{ asset('assets-admin') }}/products/p2.jpg"
                                                    alt="..." class="img-fluid rounded"></div>
                                            <div class="col"><img src="{{ asset('assets-admin') }}/products/p3.jpg"
                                                    alt="..." class="img-fluid rounded"></div>
                                            <div class="col"><img src="{{ asset('assets-admin') }}/products/p4.jpg"
                                                    alt="..." class="img-fluid rounded"></div>
                                        </div>
                                            ...
                                            <li>
                                                <a href="#!" class="avatar avatar-sm">
                                                    <img alt="..." class="avatar-img rounded-circle"
                                                        src="{{ asset('assets-admin') }}/avatars/face-1.jpg">
                                                </a>
                                            </li>
                                            <li>
                                                <a href="#!" class="avatar avatar-sm">
                                                    <img alt="..." class="avatar-img rounded-circle"
                                                        src="{{ asset('assets-admin') }}/avatars/face-4.jpg">
                                                </a>
                                            </li>
                                            <li>
                                                <a href="#!" class="avatar avatar-sm">
                                                    <img alt="..." class="avatar-img rounded-circle"
                                                        src="{{ asset('assets-admin') }}/avatars/face-3.jpg">
                                                </a>
                                            </li>
                                        </ul>
                                        <p class="small text-muted">Front-End Development <span
