           ...
           <div class="row row-eq-height">
               <div class="col-8 col-sm-7 col-md-9 col-lg-4 ">
                   <div class="footer__item"><a class="consult_logo" href="#"><img
                               src="{{ asset('assets-front') }}/img/logo.png" alt="" /></a>
                       <p>{{__('shard.footer-desc-logo')}}</p>
                   </div>
               </div>
                   ...
                   <div class="footer__item">
                       ...
                       <section class="widget-text__widget widget">
                           <div class="widget-text__content">
                               <ul>
                                   <li><a href="#">{{ __('shard.term-of-services') }}</a></li>
                                   <li><a href="#">{{ __('shard.privacy-policy') }}</a></li>
                                   <li><a href="#">{{ __('shard.sitemap') }}</a></li>
                                   <li><a href="#">{{ __('shard.help') }}</a></li>
                               </ul>
                           </div>
               ...
               <div class="col-md-4 col-lg-2 col-xl-2 ">
                   <div class="footer__item">
                       ...
                       <!-- form-sub -->
                       <div class="form-sub">
                           <h4 class="form-sub__title">{{ __('shard.our-newsletter') }}</h4>
                           <form class="form-sub__form">
                               <div class="form-item">
                                   <input class="form-control" type="email"
                                       placeholder="{{__('shard.Enter Your Email Address')}}" />
                               </div>
               ...
               <div class="col-sm-6 col-md-4 col-lg-2 col-xl-2  consult_backToTop">
                   <div class="footer__item"><a href="#" id="back-to-top"> <i class="fa fa-angle-up"
                               aria-hidden="true"> </i><span>{{ __('shard.back-to-top') }}</span></a></div>
               </div>
           </div>
       </div>
