                            ...
                            <?php else: ?>
                                <?php $__currentLoopData = $blogs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $blog): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <?php if($language == 'ar'): ?>
                                            <td><?php echo e($blog->title_ar); ?></td>
                                            <td><?php echo e($blog->category->title_ar ?? 'بدون تصنيف'); ?></td>
                                            <td><?php echo e(Str::limit($blog->description_ar, 50)); ?></td>
                                            <?php else: ?>
...
<?php $component = App\View\Components\ActionButton::resolve(['href' => ''.e(route('front.blog-detail', ['blog' => $blog])).'','type' => 'show'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component = App\View\Components\DeleteFormButton::resolve(['href' => ''.e(route('admin.blog.destroy', ['blog' => $blog])).'','id' => ''.e($blog->id).''] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
                    ...
                    <?php endif; ?><?php /**PATH E:\laragon\www\project\resources\views/admin/blog/ajax-search.blade.php ENDPATH**/ ?>