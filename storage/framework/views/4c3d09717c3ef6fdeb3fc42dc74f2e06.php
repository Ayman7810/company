        ...
        <?php if(count($certificates) > 0): ?>
            <?php $__currentLoopData = $certificates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $certificate): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    ...
                    <td><?php echo e($certificate->name_ar); ?></td>
                    <td><img width="70px" src='<?php echo e(asset("storage/certificates/$certificate->image")); ?>' alt=""></td>
                    <td><?php echo e($certificate->job_ar); ?></td>
                    <td><?php echo e(Str::words($certificate->description_ar, 10, '...')); ?></td>
                    <?php else: ?>
                    <td><?php echo e($certificate->name); ?></td>
                    <td><img width="70px" src='<?php echo e(asset("storage/certificates/$certificate->image")); ?>' alt=""></td>
                    <td><?php echo e($certificate->job); ?></td>
                    <td><?php echo e(Str::words($certificate->description, 10, '...')); ?></td>
                    <?php endif; ?>
                    <td>
...
<?php endif; ?>
                        ...
                        <?php if (isset($component)) { $__componentOriginale9eefe50b390207aad69b8e237e3dc7d = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginale9eefe50b390207aad69b8e237e3dc7d = $attributes; } ?>
<?php $component = App\View\Components\ActionButton::resolve(['href' => ' '.e(route('admin.certificate.edit', ['certificate' => $certificate])).' ','type' => 'edit'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('action-button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(App\View\Components\ActionButton::class))->getConstructor()): ?>
...
<?php $component = App\View\Components\DeleteFormButton::resolve(['href' => ''.e(route('admin.certificate.destroy', ['certificate' => $certificate])).'','id' => ''.e($certificate->id).''] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<div class="d-flex justify-content-center mt-4">
    <?php echo e($certificates->appends(request()->except('page'))->links('pagination::bootstrap-4')); ?>

</div>
<?php endif; ?><?php /**PATH E:\laragon\www\project\resources\views/admin/certificate/ajax-search.blade.php ENDPATH**/ ?>