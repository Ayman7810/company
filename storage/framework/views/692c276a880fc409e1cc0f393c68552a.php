...
<?php $__env->startSection('content'); ?>
    ...
    <div class="row justify-content-center">
        <div class="col-12">
            <h2 class="page-title"><?php echo e(__('shard.create-blog')); ?></h2>
...
<?php endif; ?>
                        ...
                        <div class="d-flex justify-content-center mt-4">
                            <button type="submit" href=""
                                class="btn btn-primary"><?php echo e(__('shard.add-new')); ?></button>
                        </div>
                    </form>
                </div>
            </div>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\laragon\www\project\resources\views/admin/blog/create.blade.php ENDPATH**/ ?>