...
<?php $__env->startSection('content'); ?>
    <div class="row justify-content-center">
        <div class="col-12">
            <h2 class="page-title"><?php echo e(__('shard.edit-service')); ?></h2>
            <div class="card shadow mb-4">
                <div class="card-body">
                    <form action="<?php echo e(route('admin.service.update', ['service' => $service])); ?>" method="post"
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" id="simpleinput" placeholder="<?php echo e(__('shard.title')); ?>"
                                        name="title" class="form-control" value="<?php echo e($service->title); ?>">
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" id="simpleinput" placeholder="<?php echo e(__('shard.title_ar')); ?>"
                                        name="title_ar" class="form-control" value="<?php echo e($service->title_ar); ?>">
                                    <?php if (isset($component)) { $__componentOriginal0b076f60ba0b4966885b7a28bd56e02e = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal0b076f60ba0b4966885b7a28bd56e02e = $attributes; } ?>
...
<?php endif; ?>
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <textarea name="description" class="form-control" placeholder="<?php echo e(__('shard.description')); ?>"><?php echo e($service->description); ?></textarea>
                                    <?php if (isset($component)) { $__componentOriginal0b076f60ba0b4966885b7a28bd56e02e = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal0b076f60ba0b4966885b7a28bd56e02e = $attributes; } ?>
...
<?php endif; ?>
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <textarea name="description_ar" class="form-control" placeholder="<?php echo e(__('shard.description_ar')); ?>"><?php echo e($service->description_ar); ?></textarea>
                                    <?php if (isset($component)) { $__componentOriginal0b076f60ba0b4966885b7a28bd56e02e = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal0b076f60ba0b4966885b7a28bd56e02e = $attributes; } ?>
...
<?php endif; ?>
                        ...
                        <div class="d-flex justify-content-center mt-4">
                            <button type="submit" href=""
                                class="btn btn-primary"><?php echo e(__('shard.edit-service')); ?></button>
                        </div>
                    </form>
                </div>
            </div>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\laragon\www\project\resources\views/admin/services/edit.blade.php ENDPATH**/ ?>