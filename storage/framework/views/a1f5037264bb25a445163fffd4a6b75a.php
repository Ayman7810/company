...
<?php $__env->startSection('content'); ?>
    <div class="row justify-content-center">
        <div class="col-12">
            <h2 class="page-title"><?php echo e(__('shard.edit-partner')); ?></h2>
            <div class="card shadow mb-4">
                <div class="card-body">
                    <form action="<?php echo e(route('admin.partner.update', ['partner' => $partner])); ?>" method="post"
                            ...
                            <div class="col-md-4">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" id="simpleinput" placeholder="<?php echo e(__('shard.name')); ?>"
                                        name="name" class="form-control" value="<?php echo e($partner->name); ?>">
                            ...
                            <div class="col-md-4">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" id="simpleinput" placeholder="<?php echo e(__('shard.name_ar')); ?>"
                                        name="name_ar" class="form-control" value="<?php echo e($partner->name_ar); ?>">
                                    <?php if (isset($component)) { $__componentOriginal0b076f60ba0b4966885b7a28bd56e02e = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal0b076f60ba0b4966885b7a28bd56e02e = $attributes; } ?>
                            ...
                            <div class="col-md-4">
                                <div class="custom-file form-group">
                                    ...
                                    <input type="file" id="example-fileinput" name="image" class="form-control"
                                        value="<?php echo e($partner->image); ?>">
                                    <?php if (isset($component)) { $__componentOriginal0b076f60ba0b4966885b7a28bd56e02e = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal0b076f60ba0b4966885b7a28bd56e02e = $attributes; } ?>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\laragon\www\project\resources\views/admin/partner/edit.blade.php ENDPATH**/ ?>