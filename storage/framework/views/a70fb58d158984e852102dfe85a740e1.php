...
<?php $__env->startSection('title', __('shard.projects')); ?>

<?php $__env->startSection('content'); ?>
    <div class="row justify-content-center">
        <div class="col-12">
            <div class="d-flex justify-content-between">
                <h2 class="page-title"><?php echo e(__('shard.projects')); ?></h2>
...
<?php endif; ?>
                            ...
                            <div id="ProjectTableSearch">
                                <?php echo $__env->make('admin.project.ajax-search', ['projects' => $projects], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                            </div>
                            <!-- end table -->
...
document.addEventListener("DOMContentLoaded", function() {
    initSearchAndPagination({
        searchRoute: "<?php echo e(route('admin.project.search')); ?>",
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\laragon\www\project\resources\views/admin/project/index.blade.php ENDPATH**/ ?>