...
<?php $__env->startSection('content'); ?>
    <div class="row justify-content-center">
        <div class="col-12">
            <h2 class="page-title"><?php echo e(__('shard.create-advisor')); ?></h2>
            <div class="card shadow mb-4">
                <div class="card-body">
                    <form action="<?php echo e(route('admin.advisor.store')); ?>" method="post" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" id="simpleinput" placeholder="<?php echo e(__('shard.insta')); ?>"
                                        name="insta" class="form-control" value="<?php echo e(old('insta')); ?>">
                                    <?php if (isset($component)) { $__componentOriginal0b076f60ba0b4966885b7a28bd56e02e = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal0b076f60ba0b4966885b7a28bd56e02e = $attributes; } ?>
                            ...
                            <div class="col-md-3">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" id="simpleinput" placeholder="<?php echo e(__('shard.feac')); ?>"
                                        name="feac" class="form-control" value="<?php echo e(old('feac')); ?>">
                                    <?php if (isset($component)) { $__componentOriginal0b076f60ba0b4966885b7a28bd56e02e = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal0b076f60ba0b4966885b7a28bd56e02e = $attributes; } ?>
                            ...
                            <div class="col-md-3">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" id="simpleinput" placeholder="<?php echo e(__('shard.twit')); ?>"
                                        name="twit" class="form-control" value="<?php echo e(old('twit')); ?>">
                                    <?php if (isset($component)) { $__componentOriginal0b076f60ba0b4966885b7a28bd56e02e = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal0b076f60ba0b4966885b7a28bd56e02e = $attributes; } ?>
...
<?php endif; ?>
                        ...
                        <div class="d-flex justify-content-center mt-4">
                            <button type="submit" href="" class="btn btn-primary"><?php echo e(__('shard.add')); ?></button>
                        </div>
                    </form>
                </div>
            </div>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\laragon\www\project\resources\views/admin/advisor/create.blade.php ENDPATH**/ ?>