...
<?php $__env->startSection('content'); ?>
    <div class="row justify-content-center">
        <div class="col-12">
            <h2 class="page-title"><?php echo e(__('shard.edit-advisor')); ?></h2>
            <div class="card shadow mb-4">
                <div class="card-body">
                    <form action="<?php echo e(route('admin.advisor.update', ['advisor' => $advisor])); ?>" method="post"
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" id="simpleinput" placeholder="<?php echo e(__('shard.name')); ?>"
                                        name="name" class="form-control" value="<?php echo e($advisor->name); ?>">
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" id="simpleinput" placeholder="<?php echo e(__('shard.name_ar')); ?>"
                                        name="name_ar" class="form-control" value="<?php echo e($advisor->name_ar); ?>">
                                    <?php if (isset($component)) { $__componentOriginal0b076f60ba0b4966885b7a28bd56e02e = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal0b076f60ba0b4966885b7a28bd56e02e = $attributes; } ?>
...
<?php endif; ?>
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <textarea name="description" class="form-control" placeholder="<?php echo e(__('shard.description')); ?>"><?php echo e($advisor->description); ?></textarea>
                                    <?php if (isset($component)) { $__componentOriginal0b076f60ba0b4966885b7a28bd56e02e = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal0b076f60ba0b4966885b7a28bd56e02e = $attributes; } ?>
...
<?php endif; ?>
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <textarea name="description_ar" class="form-control" placeholder="<?php echo e(__('shard.description_ar')); ?>"><?php echo e($advisor->description_ar); ?></textarea>
                                    <?php if (isset($component)) { $__componentOriginal0b076f60ba0b4966885b7a28bd56e02e = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal0b076f60ba0b4966885b7a28bd56e02e = $attributes; } ?>
                            ...
                            <div class="col-md-3">
                                <div class="custom-file form-group">
                                    ...
                                    <input type="file" id="example-fileinput" name="image" class="form-control"
                                        value="<?php echo e($advisor->image); ?>">
                                    <?php if (isset($component)) { $__componentOriginal0b076f60ba0b4966885b7a28bd56e02e = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal0b076f60ba0b4966885b7a28bd56e02e = $attributes; } ?>
...
<?php endif; ?>
                            ...
                            <div class="col-md-3">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" id="simpleinput" placeholder="<?php echo e(__('shard.insta')); ?>"
                                        name="insta" class="form-control" value="<?php echo e($advisor->insta); ?>">
                                    <?php if (isset($component)) { $__componentOriginal0b076f60ba0b4966885b7a28bd56e02e = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal0b076f60ba0b4966885b7a28bd56e02e = $attributes; } ?>
<?php $component = App\View\Components\ErrorForm::resolve(['name' => 'insta'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('error-form'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(App\View\Components\ErrorForm::class))->getConstructor()): ?>
...
<?php endif; ?>
                            ...
                            <div class="col-md-3">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" id="simpleinput" placeholder="<?php echo e(__('shard.feac')); ?>"
                                        name="feac" class="form-control" value="<?php echo e($advisor->feac); ?>">
                                    <?php if (isset($component)) { $__componentOriginal0b076f60ba0b4966885b7a28bd56e02e = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal0b076f60ba0b4966885b7a28bd56e02e = $attributes; } ?>
<?php $component = App\View\Components\ErrorForm::resolve(['name' => 'feac'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('error-form'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(App\View\Components\ErrorForm::class))->getConstructor()): ?>
...
<?php endif; ?>
                            ...
                            <div class="col-md-3">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" id="simpleinput" placeholder="<?php echo e(__('shard.twit')); ?>"
                                        name="twit" class="form-control" value="<?php echo e($advisor->twit); ?>">
                                    <?php if (isset($component)) { $__componentOriginal0b076f60ba0b4966885b7a28bd56e02e = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal0b076f60ba0b4966885b7a28bd56e02e = $attributes; } ?>
<?php $component = App\View\Components\ErrorForm::resolve(['name' => 'twit'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('error-form'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(App\View\Components\ErrorForm::class))->getConstructor()): ?>
...
<?php endif; ?>
                        ...
                        <div class="d-flex justify-content-center mt-4">
                            <button type="submit" href="" class="btn btn-primary"><?php echo e(__('shard.edit')); ?></button>
                        </div>
                    </form>
                </div>
            </div>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\laragon\www\project\resources\views/admin/advisor/edit.blade.php ENDPATH**/ ?>