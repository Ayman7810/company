...
<?php $__env->startSection('title', __('shard.partners')); ?>

<?php $__env->startSection('content'); ?>
    <div class="row justify-content-center">
        <div class="col-12">
            <div class="d-flex justify-content-between">
                <h2 class="page-title"><?php echo e(__('shard.partners')); ?></h2>
...
<?php $component = App\View\Components\ActionButton::resolve(['href' => ''.e(route('admin.partner.create')).'','type' => 'create'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
            <?php if (isset($component)) { $__componentOriginalea96ba6013a9791dc41f3e0b0e1b0528 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalea96ba6013a9791dc41f3e0b0e1b0528 = $attributes; } ?>
<?php $component = App\View\Components\AlertSuccess::resolve(['method' => 'success-eite'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('alert-success'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(App\View\Components\AlertSuccess::class))->getConstructor()): ?>
...
<?php endif; ?>
                            ...
                            <div id="PartnerTableSearch">
                                <?php echo $__env->make('admin.partner.ajax-search', ['partners' => $partners], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                            </div>
                        </div>
                    </div>
                </div>
...
document.addEventListener("DOMContentLoaded", function() {
    initSearchAndPagination({
        searchRoute: "<?php echo e(route('admin.partner.search')); ?>",
        tableContainerId: 'PartnerTableSearch',
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\laragon\www\project\resources\views/admin/partner/index.blade.php ENDPATH**/ ?>